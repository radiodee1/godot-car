	...
	'level': [
		{
			...
			'elements': [
				...
				},
				{
					...
					'endpoints': 3 , #10,
					'multiplier': - 1,
					'includes': [ 'KEY', 'NEXTLEVEL', 'KEY', 'PRISON_A', 'PATROL' , 'RAMPS' ] 
				},
				{
					'type': 'player',
					'x': 15 * 5 / 2,
			...
			'elements': [
				{
					...
					'z': 0,
					'mesh': 4,
					'includes': ['ALTAR', 'CAR', 'GATORS', 'HILL']
				},
				{
					'type': 'maze',
					'width_x': 15,
					...
					'endpoints': 3,
					'multiplier': - 1,
					'includes': [ 'KEY', 'PRISON_A', 'NEXTLEVEL', 'KEY', 'PATROL', 'RAMPS']
				},
				{
					'type': 'player',
					'x': 15 * 5 / 2,
		...
		},
		{
			...
			'elements': [
				...
				},
				{
					...
					'endpoints': 3, #10,
					'multiplier': - 1,
					'includes': [ 'KEY', 'PRISON_A', 'NEXTLEVEL', 'PATROL', 'RAMPS'] #, 'PRISON']
				},
				{
					'type': 'player',
					'x': 15 * 5 / 2,
